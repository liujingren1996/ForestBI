  ...
  <div style="width: auto; height: auto;">
    <table class="dialog-content pentaho-padding-sm" style="width: 100%;">
      <tbody>
        <tr>
          <td>
            <span class="label">登录出现错误！请检查后再次登录。</span>
          </td>
        </tr>
      </tbody>
    </table>
  ...
  <table class="button-panel" style="width: 100%;">
    <tbody>
      <tr>
        ...
        <td>
           <button class="pentaho-button" onclick="document.getElementById('loginError').style.display='none'">确定</button>
        </td>
      </tr>
    </tbody>
  </table>
...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
  <tr height="94">
    <td bgcolor="#FFFFFF"><div id="container_header"><div id="links"><a href="http://www.pentaho.com" target="_blank"></a><a href="http://www.pentaho.com/contact/?puc=y" target="_blank"></a></div>
        <div class="pentaho-rounded-panel" style="width: 323px; padding: 20px 20px 20px 20px; position: absolute; margin: 199px 0 0 380px;">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <form name="login" id="login" action="j_spring_security_check" method="POST">
              <tr>
                ...
                <td colspan="2" ><span style="color: #FFF; font-size: 1.7em; font-family: &quot;Franklin Gothic Demi&quot;, Tahoma, Arial; ">登录</span></td>
              </tr>
              <tr>
                ...
                <label style="color: #FFF; font-size:.85em; font-family: Tahoma, Arial, sans-serif; text-shadow: 0px 1px 1px #000;" for="userid">登录名：</label></td>
              </tr>
              <tr>
                <td colspan="2">
          ...
          <label style="padding: 15px 0 2px 0; color: #FFF; font-size:.85em; font-family: Tahoma, Arial, sans-serif; text-shadow: 0px 1px 1px #000;" for="password">密码：</label>
        </td>
              </tr>
              <tr>
                <td colspan="2">
          ...
          <span style="padding:0px 0 2px 0px; color:#fff; font-size:.8em; font-family: Tahoma, Arial, sans-serif;">在新窗口中打开</span>
        </td>
              </tr>
              <tr>
        ...
        %>
                ...
                <td style="padding:4px 0 0 0px;">
                  <input class="pentaho-button" value="登录" type="submit" style="float:right; clear: both;"/>
                </td>
              </tr>
              <%
                if (showUsers) {
  ...
  <tr height="100%">
    <td bgcolor="#FFFFFF" valign="top"><div id="container_footer" style="padding: 4px 20px 0 80px; height:200px;">©北京林业大学 版权所有</div></td>
  </tr>
</table>
